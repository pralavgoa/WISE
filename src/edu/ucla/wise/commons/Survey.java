...
public class Survey {
	...
	/*
	 * Pralav: the following function copy the above two functions for the repeating sets
	 */
	public ArrayList<Repeating_Item_Set> get_repeating_item_sets()
	{
		...
		for(int page_i=0; page_i < pages.length; page_i++)
		{
			ArrayList<Repeating_Item_Set> page_repeating_item_sets = pages[page_i].get_repeating_item_sets();
