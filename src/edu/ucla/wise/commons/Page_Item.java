...
public abstract class Page_Item {
	/** Instance Variables */
	public String name;
	...
	public static boolean IsPageItemNode(Node n) {
		...
		try {
			...
			WISE_Application.log_error("PAGE ITEM test attempt failed for "
					+ n + ": " + e, null);
		}
		return answer;
	}
	 ...
	 * subclasses
	 */
	public static Page_Item MakeNewItem(Node n) {
		String nname = null;
		Page_Item item = null;
		try {
			nname = n.getNodeName();
	...
	public Page_Item(Node n) {
		try {
			...
			WISE_Application.log_error("PAGE ITEM ROOT CONSTRUCTOR: " + e,
					null);
			return;
		}
	}
	...
	public void knitRefs(Survey mySurvey) {
		try {
			...
			WISE_Application.log_error(
					"Unimplemented Page_item method: " + e, null);
		}
	}
	...
	public char getValueType() {
		return Data_Bank.intValueTypeFlag;
	}
