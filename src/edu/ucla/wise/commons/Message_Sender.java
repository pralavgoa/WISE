...
public class Message_Sender {
	...
	public Message_Sender() {
		session = WISE_Application.get_mailSession(null);
	}
	...
	public String mailing_process(MimeMessage msg) throws MessagingException,
		...
		try {
			if (session == null) {
				WISE_Application.log_info("Session is null!!");
			}
			Transport tr = session.getTransport("smtp");
			
			if (tr == null) {
				WISE_Application.log_info("tr is null!!");
			}
			...
			if ((MailHost == null) || (user == null) || (pass == null)) {
				WISE_Application
						.log_info("MailHost or user or pass is null");
			}
			msg.saveChanges(); // don't forget this
			if (msg.getAllRecipients() == null) {
				WISE_Application.log_info("Get All Recepients is null");
			}
			...
			WISE_Application
					.log_error("Message_Sender - mailing_process failure: "
							+ e.toString(), e);
