...
public class repeating_set_read_input extends HttpServlet{
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		put_values_in_database(repeat_table_name,repeat_table_row, theUser, params, types);

		return;

	}

	private void put_values_in_database(String table_name, String row_id, User theUser, 
										...
										Hashtable<String,String> param_types)
	{
		...
		//send the table name and values to the database
				user_db_connection.insert_update_row_repeating_table(table_name,row_id ,params,param_types);
	}
}
